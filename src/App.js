        ...
        <BrowserRouter>
          ...
          <div>
            <Routes>
              ...
              <Route exact path='/News' element={<News key={'news'} country={this.state.country}  setprogress={this.setprogress} apikey={this.state.apikey} headline={"Trending Today -INDIA"} />} />
